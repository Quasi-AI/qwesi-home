...
export default function AddProductModal({ isOpen, onClose, onProductAdded, selectedStoreId = null }) {
    ...
    const uploadImages = async () => {
        const imageFiles = Object.values(images).filter(file => file)
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                onProductAdded && onProductAdded(newProduct)
                onClose()
            } else {
