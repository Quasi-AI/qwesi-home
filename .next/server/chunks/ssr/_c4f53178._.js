...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        initAuth: ()=>{
            ...
            console.log('initAuth called, auth from localStorage:', auth);
            if (auth?.token && auth?.user) {
                console.log('Setting auth state:', auth.user, auth.token);
                set({
                    user: auth.user,
                    token: auth.token,
...
function UserStores() {
    ...
    const fetchUserStores = async ()=>{
        ...
        if (!userId) {
            console.log('No user ID available, skipping store fetch');
            setStores([]);
            setLoading(false);
            return;
        }
...
//# sourceMappingURL=_c4f53178._.js.map