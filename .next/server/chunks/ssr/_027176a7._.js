        ...
        createCheckoutSession: async (data)=>{
            ...
            try {
                ...
                if (response.ok && result.success && result.checkoutUrl) {
                    ...
                    const error = result.message || "Failed to create checkout session";
                    set({
                        error
                    });
                    return {
...
"[project]/app/dashboard/subscription/page.jsx [app-ssr] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const e = new Error(`Could not parse module '[project]/app/dashboard/subscription/page.jsx'
...
//# sourceMappingURL=_027176a7._.js.map