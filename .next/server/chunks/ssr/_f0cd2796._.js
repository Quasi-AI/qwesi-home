...
function Dashboard() {
    ...
    const fetchDashboardData = async ()=>{
        ...
        try {
            // Fetch user's stores
            const storesResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authFetch"])(`${API_BASE_URL}/stores?userId=${user.id}`);
            ...
            // Fetch user's orders
            const ordersResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authFetch"])(`${API_BASE_URL}/orders?userId=${user.id}`);
...
//# sourceMappingURL=_f0cd2796._.js.map